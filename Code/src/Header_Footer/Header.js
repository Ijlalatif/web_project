...
const Header = ({cartItems,HandleComponent}) => {
    ...
    return(
        ...
        <div className={styles.button_link}>
            ...
            <button className={styles.l_S_btn} onClick={()=>navigate('/login')}>Login</button>
        ...
        <div className={styles2.top}>
            ...
            <Link to={'/items'} ><button className={styles2.i_button} onClick={() =>HandleComponent('bats')}>Cricket Bats</button></Link>
            <Link to={'/items'} ><button className={styles2.i_button} onClick={() =>HandleComponent('keeping')}>Wicket Keeping</button></Link>
            <Link to={'/items'} ><button className={styles2.i_button} onClick={() =>HandleComponent('clothing')}>Cloting</button></Link>
            <Link to={'/items'} ><button className={styles2.i_button} onClick={() =>HandleComponent('shoes')}>Cricket Shoes</button></Link>
            <Link to={'/items'} ><button className={styles2.i_button} onClick={() =>HandleComponent('protection')}>Protections</button></Link>
